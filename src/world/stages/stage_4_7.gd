...
## 4-7 '절벽 위' — LIGHT 잠금, 23시 깊은 밤.
## 적 5 (zone4 5종 — blackwood + dark_crystal + black_lily + obsidian + crystal_wraith).
## 검증 1. shadow_camp 거점 인근.

const STAGE_ID := "stage_4_7"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_4_7.png"
