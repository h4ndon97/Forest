...
## 2-2 '물웅덩이' — 2구역 자유 탐색 도입.
## 황혼 18시, 잠금 없음, 적 3 (zone2 weeping_willow + miasma_lily + drowned_pillar).
## 환경: ReflectiveFloor 1 (물 반사면 학습) + FogOverlay (얇은 안개).
## 아트 리소스가 있으면 적용, 없으면 ColorRect 플레이스홀더 유지.

const STAGE_ID := "stage_2_2"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_2_2.png"
