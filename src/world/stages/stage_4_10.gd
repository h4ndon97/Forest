...
## 4-10 '결정 미로' — NONE 잠금. 11시.
## 적 4 (zone4 — blackwood + dark_crystal + obsidian + echo_vanguard).
## 검증 3 (강화 적 + 잔영 첨병 강조).

const STAGE_ID := "stage_4_10"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_4_10.png"
