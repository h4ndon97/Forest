...
## 3-8 '잠긴 수로' — NONE 잠금, 13시.
## 적 4 (zone3 — withered_sentinel + toppled_statue + ash_lily + shattered_stele).
## **zone2 floodgate_opened flag 활용처** — flag set 시 HiddenRevealer(FLAG)가
## PortalHidden(stage_3_h)을 노출. zone2 H 미발견자는 3-6에서 발견 경로 사용.

const STAGE_ID := "stage_3_8"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_3_8.png"
