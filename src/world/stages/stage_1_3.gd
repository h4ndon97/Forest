...
## 1-3 '이끼 계곡' — 등불 + 밤 전투 + 반사 바닥 도입.
## 밤 20시, LIGHT 잠금(등불 필수), 반사 바닥 1, 적 3.
## 숨김: 등불 ON + 반사 바닥 위 센서 점등 → 비밀 장신구 자리 노출 (REFLECTION).

const STAGE_ID := "stage_1_3"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_1_3.png"
