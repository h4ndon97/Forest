...
## 4-6 '갈림의 결정' — NONE 잠금. 11시 오전.
## 적 3 (zone4 베이스 — blackwood + dark_crystal + black_lily). 호흡 + 분기 (4-7/4-8/4-H).
## Lens + LightSensor(sensor_4_6_hidden) + HiddenRevealer로 PortalHidden(stage_4_h) 노출.

const STAGE_ID := "stage_4_6"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_4_6.png"
