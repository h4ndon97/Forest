...
## 1-2 '나무 사이길' — 차폐물 도입.
## 낮 10시, 잠금 없음, 차폐물 1, 적 3(tree+rock+flower).
## 숨김: 차폐물 그림자 속 플레이어 체류 → 비밀 비문 노출 (SHADOW_COVER).

const STAGE_ID := "stage_1_2"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_1_2.png"
