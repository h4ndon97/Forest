...
## 4-3 '흑요석 안마당' — LIGHT 잠금(등불 ON 강제), 23시 깊은 밤.
## 적 4 (zone4 4종 — blackwood + dark_crystal + black_lily + **first crystal_wraith**).
## Lens + LightSensor(sensor_4_4_chasm) — 4-4 진입 게이트 활성화.

const STAGE_ID := "stage_4_3"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_4_3.png"
