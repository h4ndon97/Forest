...
## 4-2 '잠긴 협곡' — NONE 잠금. 19시.
## 적 3 (zone4 베이스 — blackwood_watcher + dark_crystal + black_lily). 호흡.

const STAGE_ID := "stage_4_2"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_4_2.png"
