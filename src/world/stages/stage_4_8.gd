...
## 4-8 '잠긴 결정 광장' — NONE 잠금, 13시.
## 적 4 (zone4 베이스 — blackwood + dark_crystal + black_lily + obsidian).
## **zone3 sealing_altar_opened flag 활용처** — flag set 시 HiddenRevealer(FLAG)가
## PortalHidden(stage_4_h) 노출. zone3 H 미발견자는 4-6 메인 경로 사용.

const STAGE_ID := "stage_4_8"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_4_8.png"
