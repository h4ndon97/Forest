...
## 3-5 '정화의 안마당' — PURIFY 잠금(stage_3_3 fully cleared 필요), 19시.
## 적 4 (zone3 베이스 — withered_sentinel + toppled_statue + ash_lily + shattered_stele).
## 정화 메커닉 재학습. 잔류 4건을 정화해야 다음 진행이 자연스럽다.

const STAGE_ID := "stage_3_5"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_3_5.png"
