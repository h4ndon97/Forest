...
## 4-4 '깊은 광맥' — ENVIRONMENT(light_sensor:sensor_4_4_chasm) 잠금, 14시.
## 적 4 (zone4 — blackwood + black_lily + crystal_wraith + obsidian).
## 4-3 Lens 회전으로 활성화된 sensor가 본 스테이지 진입 허용.

const STAGE_ID := "stage_4_4"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_4_4.png"
