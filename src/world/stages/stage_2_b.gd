...
## 2-B '늪의 어머니의 뜰' — 2구역 보스 아레나.
## 17시 저녁, 잠금 없음 (2-1~2-7 fully cleared 시 진입), 보스 1체 + 렌즈 2.
## 보스는 BossArenaTrigger 진입 시 활성화 (그 전까지 DORMANT).
## 패턴은 stage_1_b.gd 답습.

const STAGE_ID := "stage_2_b"
const SPAWN_POSITION := Vector2(80, 320)
const ARENA_WIDTH := 960
const BG_PATH := "res://assets/backgrounds/bg_stage_2_b.png"
