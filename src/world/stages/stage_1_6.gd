...
## 1-6 '빛의 공터' — 보스 전 긴장 고조.
## 10시 낮, ENVIRONMENT 잠금(1-5 센서 점등 필요), 렌즈 2, 적 4.
## 1구역 마지막 일반 스테이지. 오른쪽 포탈은 Phase 3-3 보스(1-B) 연결 예정.

const STAGE_ID := "stage_1_6"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_1_6.png"
