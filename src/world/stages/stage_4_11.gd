...
## 4-11 '잔영의 문' — LIGHT 잠금, 23시 깊은 밤.
## 적 6 (zone4 6종 모두 — blackwood/crystal/lily/obsidian/wraith/vanguard).
## 보스 직전 종합 검증.

const STAGE_ID := "stage_4_11"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_4_11.png"
