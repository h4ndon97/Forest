...
## 3-4 '깨어진 광장' — ENVIRONMENT(light_sensor:sensor_3_4_arch) 잠금, 14시.
## 적 4 (zone3 — withered_sentinel + ash_lily + old_sentinel + shattered_stele).
## 3-3에 배치된 Lens 회전으로 활성화된 sensor가 본 스테이지 진입을 허용.

const STAGE_ID := "stage_3_4"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_3_4.png"
