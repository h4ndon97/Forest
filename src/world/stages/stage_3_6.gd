...
## 3-6 '갈림 유적' — NONE 잠금. 11시 오전.
## 적 3 (zone3 베이스 — withered_sentinel + toppled_statue + ash_lily).
## 호흡 + 분기 (3-7 / 3-8 / 3-H 숨김).
## Lens + LightSensor(sensor_3_6_hidden) + HiddenRevealer로 PortalHidden(stage_3_h) 노출.

const STAGE_ID := "stage_3_6"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_3_6.png"
