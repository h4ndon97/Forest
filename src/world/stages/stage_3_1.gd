...
## 3-1 '잔해의 길' — 3구역 진입 스테이지.
## 황혼 18시, ABILITY(shadow_phase) 잠금 — 2구역 보스 보상으로 해금.
## 적 3 (zone2 placeholder — Step 7에서 zone3 적으로 교체).
## 폐허 시각: BG/Floor/Platform ColorRect 갈색 톤 + DustOverlay 옅은 먼지.
## 아트 리소스가 있으면 적용, 없으면 ColorRect 플레이스홀더 유지.

const STAGE_ID := "stage_3_1"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_3_1.png"
