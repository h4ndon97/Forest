...
## 2-5 '잠긴 둑' — PURIFY 잠금(stage_2_3 fully cleared 필요).
## 20시(밤), 적 4 (zone2 베이스 4종 — weeping_willow + mire_stone + miasma_lily + drowned_pillar).
## 정화 메커닉 재학습 스테이지 — 잔류 4건을 정화해야 다음 진행이 자연스럽다.

const STAGE_ID := "stage_2_5"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_2_5.png"
