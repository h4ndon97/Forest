...
## 3-H '봉인의 단' — 숨김(HiddenRevealer로 진입), 6시 새벽.
## 적 2 (zone3 — old_sentinel × 2, 봉인 제단 영역 위협).
## **추가조작: 봉인 제단** (1개) — 활성화 시 `world.zone3.sealing_altar_opened` flag set.
## 가장 밝은 zone3 톤 (휴식·발견 분위기). 활용처는 Phase 4-C zone4에서 결정.

const STAGE_ID := "stage_3_h"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_3_h.png"
