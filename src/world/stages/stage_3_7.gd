...
## 3-7 '부서진 첨탑' — LIGHT 잠금(등불 ON 강제), 23시 깊은 밤.
## 적 5 (zone3 5종 모두 — willow + statue + lily + stele + sentinel).
## 보스 직전 검증 1. 가장 어두운 zone3 톤.

const STAGE_ID := "stage_3_7"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_3_7.png"
