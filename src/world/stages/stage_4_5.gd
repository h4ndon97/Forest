...
## 4-5 '정화의 동굴' — PURIFY(stage_4_3 fully cleared 필요), 20시.
## 적 4 (zone4 베이스 — blackwood + dark_crystal + black_lily + obsidian).
## 정화 메커닉 재학습. wraith/vanguard 제외 (4-3에서 학습 끝, zone3 패턴 답습).

const STAGE_ID := "stage_4_5"
const SPAWN_POSITION := Vector2(80, 320)
const BG_PATH := "res://assets/backgrounds/bg_stage_4_5.png"
